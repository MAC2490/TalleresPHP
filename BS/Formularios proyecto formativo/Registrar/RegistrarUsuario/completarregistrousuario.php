...
<body>
    <form action="terminarRegistro.php">
        <form class="row g-3">
            <div class="container">
                <h1 class="text-center">Terminar Registro</h1>
                <div class="row">
                    <div class="col-md-6">
                        <label for="inputEmail4" class="form-label">Nombre</label>
                        <input type="text" class="form-control" id="inputEmail4" name="nombre_usuario">
                    </div>
                    <div class="col-md-6">
    ...
    <div class="text-center">
        <a class="btn btn-outline-info mt-2" href="http://localhost/ADSO-2593917/BS/Formularios%20proyecto%20formativo/Registrar/RegistrarUsuario/ingresarusuario.php" role="button">Salir</a>
    </div>
</body>
</html>